...
| V3      | 🚧 EN PRUEBA 🚧  | Abril 2026 |  - Modificación del footprint de un boost que implicaban tener que forzar su entrada.- Modificación de la PCB para no tener que seccionar dos pines al TLV.
